  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        {},
        "Mail has been sent on your email ID",
      ),
    );
})
...
const forgotPasswordRequest = asyncHandler(async(req,res)=>{
  ...
  user.generateTemporaryToken = tokenExpiry
  ...
  return res.status(200)
  .json(
    new ApiResponse(200,{},"Password resent mail has been sent your mail")
  )
